...
function search(rows) {
  ...
  return rows.filter(
    (row) =>
      ...
      row.iata.toLowerCase().indexOf(q) > -1 ||
      row.icao.toLowerCase().indexOf(q) > -1 
  );
}
  ...
  return (
    <div className="container-fluid">
      <div style={{ padding: 30}}>
        ...
        <div>
          <Row className="banner" style={{ background: "red", padding: 40 }}>
            <div className="col-10 bannerinside">
              <div>
                <h1>
        ...
        <div>
          <Row
            ...
            style={{ background: "red", padding: 40 }}
          >
            <div className="col-6 bannercheckbox">
              <div className="typetext">TYPE</div>
              <Row>
                <Col>
                  <Checkbox
