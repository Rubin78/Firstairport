...
const [searchColumns, setSearchColumns] = useState(["name", "city");
...
function search(rows) {
  console.log(rows)
  return rows.filter((row) => searchColumns.some((column)=>row && row[column].toString().toLowerCase().indexOf(q.toLowerCase()) > - 1)
