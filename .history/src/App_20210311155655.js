...
export default class App extends Component {
  ...
  changeBrand = () => {
    this.setState({ brand: "tma", car: "lmv", Scammer: "saquib" });
  };

  render() {
    return (
      <div>
        <h1>this is the brand name of car   {this.state.brand}</h1>
        <h1>this is the name of car {this.state.car}</h1>
        <h1>this is the scammer {this.state.Scammer}</h1>

        <button onClick={this.changeBrand}>hello </button>
      </div>
    );
  }
}
